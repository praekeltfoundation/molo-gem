...
CORE_INFRASTRUCTURE_CLIENT_ID = environ.get('CORE_INFRASTRUCTURE_CLIENT_ID', '')
CORE_INFRASTRUCTURE_CLIENT_SECRET = environ.get('CORE_INFRASTRUCTURE_CLIENT_SECRET', '')
