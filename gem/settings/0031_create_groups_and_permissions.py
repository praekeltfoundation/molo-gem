...
def create_groups_and_permissions(apps, schema_editor):
    ...
    view_yourwords_entries = Permission.objects.get(codename='can_view_entry')
    group_names = ('product_admin', 'data_admin', 'data_viewer',
                   'content_admin', 'content_admin')
    for group_name in group_names:
        group = Group.objects.get(name=group_name).first()
        group.permissions.add(view_yourwords_entries)
